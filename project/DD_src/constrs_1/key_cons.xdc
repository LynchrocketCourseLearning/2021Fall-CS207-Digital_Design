...
set_property IOSTANDARD LVCMOS33 [get_ports modem0]
set_property IOSTANDARD LVCMOS33 [get_ports sw1]
set_property IOSTANDARD LVCMOS33 [get_ports modem2]
set_property IOSTANDARD LVCMOS33 [get_ports sw2]
set_property IOSTANDARD LVCMOS33 [get_ports next0]
set_property IOSTANDARD LVCMOS33 [get_ports modem1]
set_property PACKAGE_PIN W4 [get_ports modem0]
set_property PACKAGE_PIN R4 [get_ports modem1]
set_property PACKAGE_PIN T4 [get_ports modem2]
...
set_property PACKAGE_PIN U6 [get_ports rstm]

set_property IOSTANDARD LVCMOS33 [get_ports rstk]
set_property PACKAGE_PIN W5 [get_ports rstk]

set_property IOSTANDARD LVCMOS33 [get_ports nextt]
set_property PACKAGE_PIN V5 [get_ports nextt]